...
test('assert building a node with 1 property', function(t) {
  ...
  var node = tosca.node_build()
  t.equal(typeof node, 'object', 'assert node is object')

  var node_with_props = tosca.node_add_property(node, 'color', 'green')
...
test('assert building a node with 2 properties', function(t) {
  ...
  var node = tosca.node_build()  
  var node_with_props  = tosca.node_add_property(node, 'color', 'green')
  var node_with_2props = tosca.node_add_property(node_with_props, 'size', 'large')
...
test('assert building node_instance', function(t) {
  ...
  var instance = tosca.instance_build()
...
test('assert building node_instance with state', function(t) {
  ...
  var instance = tosca.instance_build()
  var instance_with_state = tosca.instance_add_state(instance, 'started')  
...
test('assert building node_instance with properties', function(t) {
  ...
  var instance = tosca.instance_build()
  var instance_with_props = tosca.instance_add_property(instance, 'color', 'red')
